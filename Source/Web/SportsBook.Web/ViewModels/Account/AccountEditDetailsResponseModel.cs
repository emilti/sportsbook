namespace SportsBook.Web.ViewModels.Account
{
    ...
    public class AccountEditDetailsResponseModel : IMapTo<AppUser>, IHaveCustomMappings
    {
        private ICollection<SportCategory> sportCategories;
        private ICollection<Facility> facilities;

        public AccountEditDetailsResponseModel()
        {
        ...
        {
            configuration.CreateMap<SportsBook.Data.Models.AppUser, AccountEditDetailsResponseModel>();
        }
    }
}